...
The plugin's design record measured a maximum error under approximately \SI{0.5}{\decibel} for the cascade over \SIrange{20}{20000}{\hertz}, across distances of \SIrange{2}{30}{\meter} and relative humidities of \SIrange{10}{90}{\percent}, against \SIrange{8}{13}{\decibel} for a three-section \emph{first-order} cascade at fixed corners, measured at \SI{30}{\meter}.
The qualifier \emph{at fixed corners} matters: the figure is the achievable error for a first-order cascade constrained, like the shipped design, to a single distance-independent set of corner frequencies, and a first-order design free to re-place its corners per distance would fit more tightly.
