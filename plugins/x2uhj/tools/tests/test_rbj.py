...
def test_golden_coefficients():
    ...
    b, a = rbj_allpass(1000.0, Q_SQRT2, 48000.0)
    assert a[0] == 1.0
    np.testing.assert_allclose(a[1], -1.815341, atol=1e-5)  # atol=1e-5 matches the 6-decimal precision of the hand-computed reference values
